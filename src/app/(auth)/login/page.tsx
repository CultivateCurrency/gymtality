  ...
  return (
    <div className="w-full">
      ...
      <div className="flex gap-3 mb-6">
        <button className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 bg-zinc-900 border border-zinc-800 hover:border-zinc-700 rounded-xl text-[13px] font-medium text-zinc-300 hover:text-white transition-all">
